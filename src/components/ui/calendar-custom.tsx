...
function CalendarCustom({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        caption_end: 'w-full h-full flex flex-col',
        ...
        table: 'flex-1 flex flex-col w-full border-collapse space-y-1',
        tbody: 'h-full flex flex-col justify-evenly',
        head_row: 'flex justify-evenly',
        head_cell:
          'text-muted-foreground rounded-md w-8 font-normal text-[0.8rem]',
        row: 'flex w-full justify-evenly mt-2',
        cell: cn(
